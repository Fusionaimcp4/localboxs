...
import { footerLinkGroups, socialLinks, footerConfig, type FooterLinkGroup, type SocialLink } from "@/data/footerLinks";
      ...
      <div className="relative z-10 w-full max-w-[1320px] mx-auto px-5 py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <Link href="/" className="group flex items-center gap-3">
              <span className="text-foreground text-2xl font-bold bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent flex items-center gap-1">
                LocalBox
                <Image
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-4 gap-8">
            {footerLinkGroups.map((group: FooterLinkGroup) => (
