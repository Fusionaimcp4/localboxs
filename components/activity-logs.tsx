      ...
      <CardHeader className="bg-slate-50 dark:bg-slate-700/50 border-b border-slate-200 dark:border-slate-700">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            size="sm"
            disabled={refreshing}
            className="border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 bg-white dark:bg-slate-800"
          >
                ...
                <tr key={log.id} className="border-b border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                  <td className="py-3 px-2 text-sm">
                    <div className="flex flex-col">
                      <span className="font-medium text-slate-900 dark:text-slate-100">{formatTimestamp(log.timestamp)}</span>
                      {log.fallback_reason && (
                        <Badge variant="secondary" className="text-xs mt-1 w-fit bg-slate-100 dark:bg-slate-600 text-slate-700 dark:text-slate-300">
                  ...
                  <td className="py-3 px-2">
                    <div className="flex flex-col gap-1">
                      <Badge className={`text-xs w-fit ${getProviderBadgeColor(log.provider)}`}>
                        {log.provider}
                      </Badge>
                      <Badge className={`text-xs w-fit ${getModelBadgeColor(log.model)}`}>
                        {log.model}
                      </Badge>
                    </div>
                  </td>
