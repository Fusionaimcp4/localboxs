          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {[
              ...
              },
              {
                ...
                answer: "Your data and setup remain intact and safe. To continue using LocalBoxs, simply choose a plan and provide your payment details."
              },
              {
                question: "Can I respond to chats that my chatbot handles?",
                answer: "Yes. LocalBoxs can transfer a chat to a human agent in LiveChat or create a ticket in HelpDesk."
              },
              {
                question: "Where do you store data?",
                answer: "LocalBoxs stores its customers' information in secure data centers with encryption and compliance certifications."
              },
              {
              ...
              },
              {
                ...
                answer: "LocalBoxs lets you build bots in any language. The dashboard is available in multiple languages."
              },
              {
            ...
            <div className="relative">
              ...
              <div className="absolute -top-6 -right-6 bg-white dark:bg-slate-800 rounded-xl p-4 shadow-xl border border-slate-200 dark:border-slate-700">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">LocalBoxs</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg p-8 md:p-12">
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-slate-100 mb-4">
                Start using LocalBoxs right away
              </h2>
            </div>
