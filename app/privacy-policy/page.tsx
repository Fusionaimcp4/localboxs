...
export const metadata = {
  title: "Privacy Policy | LocalBoxs",
  description:
    "Learn how LocalBoxs (the Africa-focused sister platform of Voxe by MCP4 AI) collects, uses, stores, and protects your data, including chat transcripts and integrations.",
}
    ...
    <main className="w-full px-5 py-12 md:py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none mt-8 space-y-6">
          <p>
            LocalBoxs ("LocalBoxs", "we", "our", or "us") provides an AI-powered customer
            ...
            localboxs.com and related services. Localboxs.com is the Africa-focused version of Voxe,
