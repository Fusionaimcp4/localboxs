...
export const metadata = {
  title: "Terms of Service | LocalBoxs",
  description:
    "Read the Terms of Service for LocalBoxs, the Africa-focused sister platform of Voxe by MCP4 AI. Covers usage, payments, limitations, and governing law.",
}
    ...
    <main className="w-full px-5 py-12 md:py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none mt-8 space-y-6">
          ...
          <p>
            By accessing or using LocalBoxs (the “Service”), you agree to these Terms of Service
          ...
          <p>
            LocalBoxs provides an AI + human hybrid customer support platform. AI agents handle
          ...
          <p>
            By using Localboxs.com, you acknowledge that interactions may involve AI responses
            generated for speed and efficiency. Localboxs makes reasonable efforts to ensure
          ...
          <p>
            ...
            LOCALBOXS AND MCP4 AI DISCLAIM ALL WARRANTIES AND LIMIT LIABILITY FOR INDIRECT,
          ...
          <p>
            ...
            conflict of law principles, pending LocalBoxs' local incorporations.
          </p>
