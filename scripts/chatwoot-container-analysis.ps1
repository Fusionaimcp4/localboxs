...
Write-Host "Your LocalBoxs app is trying to access: https://chatwoot.mcp4.ai" -ForegroundColor White
...
Write-Host "Option 1: Update LocalBoxs to use local Chatwoot" -ForegroundColor Yellow
